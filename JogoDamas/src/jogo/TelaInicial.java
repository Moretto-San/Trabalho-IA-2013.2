...
public class TelaInicial extends JFrame {
	...
	private void initialize() {
		frmDamas = new JFrame();
		frmDamas.setIconImage( Toolkit.getDefaultToolkit().getImage( TelaInicial.class.getResource( "/img/04-damas.png" ) ) );
	...
	private JLabel getLblNewLabel() {
		if( lblNewLabel == null ) {
			...
			lblNewLabel.setIcon( new ImageIcon( TelaInicial.class.getResource( "/img/04-damas.png" ) ) );
	...
	private JLabel getLblIniciarJogo() {
		if( lblIniciarJogo == null ) {
			...
			lblIniciarJogo.setIcon( new ImageIcon( TelaInicial.class.getResource( "/img/Next72.png" ) ) );
			lblIniciarJogo.setVisible( false );
			lblIniciarJogo.setCursor( Cursor.getPredefinedCursor( Cursor.HAND_CURSOR ) );
			lblIniciarJogo.setFont( new Font( "Segoe UI", Font.BOLD | Font.ITALIC, 28 ) );
